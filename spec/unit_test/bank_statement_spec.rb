...
describe BankStatement do
  ...
  describe '#deposit_statement' do 
    it 'accepts deposit' do
      expect(transaction_class).to receive(:new).with("12/01/2020", '%.2f' % 1000, nil, '%.2f' % 1000)
  ...
  describe '#withdraw_statement' do 
    it 'accepts withdraw' do 
      expect(transaction_class).to receive(:new).with("12/01/2020", nil, '%.2f' % 2000, '%.2f' % 2000)
